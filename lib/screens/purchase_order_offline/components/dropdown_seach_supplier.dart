...
class DropdownSearchSupplierWidget extends StatefulWidget {
  @override
  _DropdownSearchSupplierWidgetState createState() =>
      _DropdownSearchSupplierWidgetState();
}

class _DropdownSearchSupplierWidgetState
    extends State<DropdownSearchSupplierWidget> {
